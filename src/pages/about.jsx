const AboutPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-teal-950 to-slate-950 p-8 text-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-6xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-emerald-400 to-orange-400 tracking-tight">
            ABOUT US
          </h1>
          <div className="w-32 h-1 bg-gradient-to-r from-cyan-400 via-emerald-400 to-orange-400 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl p-8 border-2 border-cyan-400/30 hover:border-cyan-400/60 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/20">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl p-8 border-2 border-orange-400/30 hover:border-orange-400/60 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/20">
              <div className="flex items-start gap-4">
                <span className="text-5xl flex-shrink-0">💰</span>
                <p className="text-lg leading-relaxed text-slate-200">
                  Our platform offers{' '}
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl p-8 border-2 border-emerald-400/30 hover:border-emerald-400/60 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/20">
              <div className="flex items-start gap-4">
                <span className="text-5xl flex-shrink-0">✅</span>
                <p className="text-lg leading-relaxed text-slate-200">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl p-8 border-2 border-cyan-400/30 hover:border-orange-400/60 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/20">
              <div className="flex items-start gap-4">
                <span className="text-5xl flex-shrink-0">🌟</span>
                <p className="text-lg leading-relaxed text-slate-200">
          ...
          <div className="relative group mt-10">
            ...
            <div className="relative bg-gradient-to-br from-slate-900 via-teal-900/50 to-slate-900 backdrop-blur-xl rounded-2xl p-10 border-2 border-emerald-400/50 hover:border-emerald-400/80 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/30">
